...
<div class="content">
	<div class="l">
		<div class="main_lb">
			...
			<dl>
				<dt><a href="<?=randList('qiye')?>">便民服务</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
                    <?php endforeach;?>
				</dd>

				<dt><a href="<?=randList('qiye')?>">餐饮美食</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">休闲娱乐</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">教育培训</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">婚庆/摄影</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">车辆服务</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">旅游酒店</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">商务服务</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">购物服务</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">党政文体卫</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
				...
				<dt><a href="<?=randList('qiye')?>">公司/工厂</a></dt>
				<dd>
                    <?php $type = typeName('company',10)?>
                    <?php foreach ($type as $item):?>
						<a href="<?=randList('qiye')?>"><?=$item['name']?></a>
			...
			<ul class="qy_list">
                <?php $article = randArticle('qiye',20)?>
                ...
                <?php endforeach;?>
                <?php $article = randArticle('qiye',50)?>
                <?php foreach ($article as $item):?>
					<li>
						<a href="<?=$item['url']?>" target="_blank">
							<br/><?=$item['title']?>
	...
	<div class="r">
		<div class="apply"><a href="<?=randList('qiye')?>">申请收录我的商家</a></div>
		...
		<ul class="box">
			<li><a href="<?=randList('qiye')?>">诚商通是企业会员身份，是网络营销工具</a></li>
			<li><a href="<?=randList('qiye')?>">它可以全面展示公司形象及产品服务</a></li>
			<li><a href="<?=randList('qiye')?>">诚商通企业信息在列表页优先展示</a></li>
			<li><a href="<?=randList('qiye')?>">拥有定时自动涮新信息等特权</a></li>
