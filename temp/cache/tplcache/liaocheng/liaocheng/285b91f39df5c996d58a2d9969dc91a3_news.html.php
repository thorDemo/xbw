...
<div class="content">
    <div class="l">
        ...
        <div class="box">
            ...
            <div class="info_bottom">【<a href="<?=randList('news')?>" rel="nofollow">写进Blog</a>】 【<a
                    href="<?=randList('news')?>" rel="nofollow">点评留言</a>】 【<a href="<?=randList('news')?>" rel="nofollow">在线投稿</a>】 【<a
            ...
            <div class="tC"><a target="_blank" href="<?=randList('news')?>"><img alt="" src="<?php echo $this->_var['theme_path']; ?>/img/news.gif"/></a>
            </div>
            <h3>相关文章</h3>
            <ul>
