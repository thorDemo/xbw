...
<div class="content">
    <div class="l">
        ...
        <h1 class="c_bt"><?=$article['title'];?></h1>
        ...
        <div class="c_nr">
            <p><img src="<?=randPic('news')?>" alt="<?=$article['title'];?>" /></p>
            <?=$article['content'];?>
        </div>
    ...
    <div class="r">
        <div class="abc k208 tC">
            <img src="<?=randPic('news')?>" alt="" style="padding:10px 0 5px 0;max-width:180px;max-height:180px;"/><br/>特别推荐↑
        </div>
        ...
        <div class="abc k208 t_5">
            <h5>置顶信息随机展示</h5>
            <ul class="abc_news">
                <?php $article = randArticle('fangchan',30)?>
                <?php for($i=0; $i<count($article); $i++):?>
		            <li><a href="<?=$article[$i]['url']?>" target="_blank"><?=$article[$i]['title']?></a></li>
                <?php endfor;?>
            </ul>
