...
<div class="content">
	<div class="p_l">
		<div class="p_xinxi">
			<dl>
				<dt><?=$article['title']?></dt>
				<dd class="t_10">类别：<a href="<?=randList('qiye')?>"><?=typeName()?></a> &raquo; <a href="<?=randList('qiye')?>"><?=typeName()?></a></dd>
				<dd>地区：<?=randPlace()?></dd>
				...
				<dd class="t_10 tR">
					<a href="<?php randList('qiye')?>" rel="nofollow">分享/转发</a> | <a href="javascript:window.print()">打印</a> | <a
		...
		<div class="p_nr">
			发表评论前，请先 <a href="<?=randList('qiye')?>">注册</a> 或 <a href="<?=randList('qiye')?>">登陆</a>
		</div>
	</div>
	<div class="p_r">
		<div class="p_box tC">
			<div id="wx_qrcode"><img
						src="<?=randPic()?>"
						style="padding:10px 0 5px 0;max-width:180px;max-height:180px;"><br>
				<?=$article['title']?><font
						color="Red">微站</font>↑
			</div>
		...
		<a href="<?=randList('qiye')?>"><img alt="诚商通" src="<?php echo $this->_var['theme_path']; ?>/images/ad_2401.gif" class="aaa"/></a>
		<div class="p_box t_10">
			<h5>您可能感兴趣的商户</h5>
			<ul>
                <?php $article = randMeta(null,['url','title'],30)?>
