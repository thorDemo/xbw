...
<div class="content">
	<div class="l">
		<div class="news_dh">您所在的位置：<a href="/">聊城信息港</a> &gt; <a href="/news/">资讯中心</a> &gt; <a
					href='<?=randList('ershou')?>'>热点聚集</a></div>
		<div class="box">
			<h1><?=$article['title'];?></h1>
			...
			<div class="info_bottom">【<a href="<?=randList('ershou')?>" rel="nofollow">写进Blog</a>】 【<a
						href="<?=randList('ershou')?>" rel="nofollow">点评留言</a>】 【<a href="<?=randList('ershou')?>" rel="nofollow">在线投稿</a>】 【<a
			...
			<div class="tC"><a target="_blank" href="<?=randList('ershou')?>"><img alt="" src="<?php echo $this->_var['theme_path']; ?>/img/news.gif"/></a>
			</div>
			<h3>相关文章</h3>
			<ul>
                <?php $article = randArticle('ershou',10)?>
